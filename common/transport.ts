...
export const allShowParsedDate =
{
    showList:
        [{
            ...
            tvrage: 764,
            startDate: new Date("1961-10-01"),
            endDate: new Date("1961-11-01"),
            numberOfEpisodes: 7,
            runTime: 45,
            network: 'BBC',
            country: 'UK'
